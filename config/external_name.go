...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"databricks_automatic_cluster_update_workspace_setting":     config.IdentifierFromProvider,
	"databricks_aws_s3_mount":                                   config.IdentifierFromProvider,
	"databricks_azure_adls_gen1_mount":                          config.IdentifierFromProvider,
	"databricks_azure_adls_gen2_mount":                          config.IdentifierFromProvider,
	"databricks_azure_blob_mount":                               config.IdentifierFromProvider,
