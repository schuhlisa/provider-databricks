...
type QueryInitParameters_2 struct {
	...
	Parameter []QueryParameterInitParameters `json:"parameter,omitempty" tf:"parameter,omitempty"`
...
type QueryObservation_2 struct {
	...
	// Query parameter definition.  Consists of following attributes (one of *_value is required):
	Parameter []QueryParameterObservation `json:"parameter,omitempty" tf:"parameter,omitempty"`
...
type QueryParameters_2 struct {
	...
	// Query parameter definition.  Consists of following attributes (one of *_value is required):
	// +kubebuilder:validation:Optional
	Parameter []QueryParameterParameters `json:"parameter,omitempty" tf:"parameter,omitempty"`
...
type QuerySpec struct {
	...
	ForProvider     QueryParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider QueryInitParameters_2 `json:"initProvider,omitempty"`
}

// QueryStatus defines the observed state of Query.
type QueryStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        QueryObservation_2 `json:"atProvider,omitempty"`
}
