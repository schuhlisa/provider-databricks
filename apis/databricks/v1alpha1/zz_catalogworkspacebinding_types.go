...
type CatalogWorkspaceBindingParameters struct {
...
type CatalogWorkspaceBindingSpec struct {
	...
	// autoscaler.
	InitProvider CatalogWorkspaceBindingInitParameters `json:"initProvider,omitempty"`
}
...
// CatalogWorkspaceBinding is the Schema for the CatalogWorkspaceBindings API. ""subcategory: "Unity Catalog"
...
// CatalogWorkspaceBindingList contains a list of CatalogWorkspaceBindings
type CatalogWorkspaceBindingList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []CatalogWorkspaceBinding `json:"items"`
}

// Repository type metadata.
var (
	CatalogWorkspaceBinding_Kind             = "CatalogWorkspaceBinding"
	CatalogWorkspaceBinding_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: CatalogWorkspaceBinding_Kind}.String()
	CatalogWorkspaceBinding_KindAPIVersion   = CatalogWorkspaceBinding_Kind + "." + CRDGroupVersion.String()
	CatalogWorkspaceBinding_GroupVersionKind = CRDGroupVersion.WithKind(CatalogWorkspaceBinding_Kind)
)

func init() {
	SchemeBuilder.Register(&CatalogWorkspaceBinding{}, &CatalogWorkspaceBindingList{})
}
