...
type LakehouseMonitorInitParameters struct {
	...
	Schedule []LakehouseMonitorScheduleInitParameters `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type LakehouseMonitorObservation struct {
	...
	// The schedule for automatically updating and refreshing metric tables.  This block consists of following fields:
	Schedule []LakehouseMonitorScheduleObservation `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type LakehouseMonitorParameters struct {
	...
	// The schedule for automatically updating and refreshing metric tables.  This block consists of following fields:
	// +kubebuilder:validation:Optional
	Schedule []LakehouseMonitorScheduleParameters `json:"schedule,omitempty" tf:"schedule,omitempty"`
...
type LakehouseMonitorScheduleInitParameters struct {
...
type LakehouseMonitorScheduleObservation struct {
...
type LakehouseMonitorScheduleParameters struct {
...
type NotificationsOnFailureObservation struct {
	EmailAddresses []*string `json:"emailAddresses,omitempty" tf:"email_addresses,omitempty"`
}

type NotificationsOnFailureParameters struct {
