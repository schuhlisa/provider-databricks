...
func (mg *ServicePrincipalSecret) GetTerraformResourceType() string {
	return "databricks_service_principal_secret"
}
...
// LateInitialize this ServicePrincipalSecret using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ServicePrincipalSecret) LateInitialize(attrs []byte) (bool, error) {
	params := &ServicePrincipalSecretParameters{}
