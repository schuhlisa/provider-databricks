...
type SQLQueryScheduleInitParameters struct {
	Continuous []ScheduleContinuousInitParameters `json:"continuous,omitempty" tf:"continuous,omitempty"`
...
type SQLQueryScheduleObservation struct {
	Continuous []ScheduleContinuousObservation `json:"continuous,omitempty" tf:"continuous,omitempty"`
...
type SQLQueryScheduleParameters struct {
	...
	// +kubebuilder:validation:Optional
	Continuous []ScheduleContinuousParameters `json:"continuous,omitempty" tf:"continuous,omitempty"`
...
type ScheduleContinuousInitParameters struct {
	IntervalSeconds *float64 `json:"intervalSeconds,omitempty" tf:"interval_seconds,omitempty"`

	UntilDate *string `json:"untilDate,omitempty" tf:"until_date,omitempty"`
}

type ScheduleContinuousObservation struct {
	IntervalSeconds *float64 `json:"intervalSeconds,omitempty" tf:"interval_seconds,omitempty"`

	UntilDate *string `json:"untilDate,omitempty" tf:"until_date,omitempty"`
}

type ScheduleContinuousParameters struct {
