...
type FileInitParameters_2 struct {
...
type FileSpec struct {
	...
	ForProvider     FileParameters_2 `json:"forProvider"`
	...
	// autoscaler.
	InitProvider FileInitParameters_2 `json:"initProvider,omitempty"`
}

// FileStatus defines the observed state of File.
type FileStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        FileObservation_2 `json:"atProvider,omitempty"`
}
...
// File is the Schema for the Files API. ""subcategory: "Storage"
