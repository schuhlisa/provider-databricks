...
type PartitionInitParameters struct {
	...
	Value []PartitionValueInitParameters `json:"value,omitempty" tf:"value,omitempty"`
}

type PartitionObservation struct {

	// The value of the partition column. When this value is not set, it means null value. When this field is set, field recipient_property_key can not be set.
	Value []PartitionValueObservation `json:"value,omitempty" tf:"value,omitempty"`
}
...
type PartitionParameters struct {
	...
	// The value of the partition column. When this value is not set, it means null value. When this field is set, field recipient_property_key can not be set.
	// +kubebuilder:validation:Optional
	Value []PartitionValueParameters `json:"value,omitempty" tf:"value,omitempty"`
}

type PartitionValueInitParameters struct {
...
type PartitionValueObservation struct {
...
type PartitionValueParameters struct {
