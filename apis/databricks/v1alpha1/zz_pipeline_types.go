...
type LibraryNotebookInitParameters struct {
	Path *string `json:"path,omitempty" tf:"path,omitempty"`
}

type LibraryNotebookObservation struct {
	Path *string `json:"path,omitempty" tf:"path,omitempty"`
}

type LibraryNotebookParameters struct {
...
type PipelineLibraryInitParameters struct {
	...
	Notebook []LibraryNotebookInitParameters `json:"notebook,omitempty" tf:"notebook,omitempty"`
...
type PipelineLibraryObservation struct {
	...
	// & file types are supported.
	Notebook []LibraryNotebookObservation `json:"notebook,omitempty" tf:"notebook,omitempty"`
...
type PipelineLibraryParameters struct {
	...
	// & file types are supported.
	// +kubebuilder:validation:Optional
	Notebook []LibraryNotebookParameters `json:"notebook,omitempty" tf:"notebook,omitempty"`
...
// Pipeline is the Schema for the Pipelines API. ""subcategory: "Compute"
