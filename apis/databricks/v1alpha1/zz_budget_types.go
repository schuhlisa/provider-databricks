...
type TagsInitParameters struct {
	...
	Value []TagsValueInitParameters `json:"value,omitempty" tf:"value,omitempty"`
}
...
type TagsObservation struct {
	...
	// Consists of the following fields:
	Value []TagsValueObservation `json:"value,omitempty" tf:"value,omitempty"`
}
...
type TagsParameters struct {
	...
	// Consists of the following fields:
	// +kubebuilder:validation:Optional
	Value []TagsValueParameters `json:"value,omitempty" tf:"value,omitempty"`
}

type TagsValueInitParameters struct {
...
type TagsValueObservation struct {
...
type TagsValueParameters struct {
...
// Budget is the Schema for the Budgets API. ""subcategory: "FinOps"
