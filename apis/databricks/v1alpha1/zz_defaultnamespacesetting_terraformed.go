...
func (mg *DefaultNamespaceSetting) GetTerraformResourceType() string {
	return "databricks_default_namespace_setting"
}
...
// LateInitialize this DefaultNamespaceSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *DefaultNamespaceSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &DefaultNamespaceSettingParameters{}
