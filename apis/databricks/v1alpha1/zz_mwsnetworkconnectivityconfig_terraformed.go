...
func (tr *MwsNetworkConnectivityConfig) GetID() string {
...
// LateInitialize this MwsNetworkConnectivityConfig using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MwsNetworkConnectivityConfig) LateInitialize(attrs []byte) (bool, error) {
	params := &MwsNetworkConnectivityConfigParameters{}
