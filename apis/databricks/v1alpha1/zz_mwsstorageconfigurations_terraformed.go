...
func (tr *MwsStorageConfigurations) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"account_id": "accountIdSecretRef"}
}
...
// LateInitialize this MwsStorageConfigurations using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *MwsStorageConfigurations) LateInitialize(attrs []byte) (bool, error) {
	params := &MwsStorageConfigurationsParameters{}
