...
type VectorSearchIndexObservation struct {
	...
	Status []VectorSearchIndexStatusObservation `json:"status,omitempty" tf:"status,omitempty"`
}
...
type VectorSearchIndexStatusInitParameters struct {
}

type VectorSearchIndexStatusObservation struct {
...
type VectorSearchIndexStatusParameters struct {
}
