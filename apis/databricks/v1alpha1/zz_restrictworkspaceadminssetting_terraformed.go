...
func (mg *RestrictWorkspaceAdminsSetting) GetTerraformResourceType() string {
	return "databricks_restrict_workspace_admins_setting"
}
...
// LateInitialize this RestrictWorkspaceAdminsSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *RestrictWorkspaceAdminsSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &RestrictWorkspaceAdminsSettingParameters{}
