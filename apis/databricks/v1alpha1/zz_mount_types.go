...
type MountInitParameters struct {
	...
	// to mount AWS S3
	S3 []MountS3InitParameters `json:"s3,omitempty" tf:"s3,omitempty"`
...
type MountObservation struct {
	...
	// to mount AWS S3
	S3 []MountS3Observation `json:"s3,omitempty" tf:"s3,omitempty"`
...
type MountParameters struct {
	...
	// to mount AWS S3
	// +kubebuilder:validation:Optional
	S3 []MountS3Parameters `json:"s3,omitempty" tf:"s3,omitempty"`
...
type MountS3InitParameters struct {
...
type MountS3Observation struct {
