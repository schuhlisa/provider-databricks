...
func (mg *EnhancedSecurityMonitoringWorkspaceSetting) GetTerraformResourceType() string {
	return "databricks_enhanced_security_monitoring_workspace_setting"
}
...
// LateInitialize this EnhancedSecurityMonitoringWorkspaceSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *EnhancedSecurityMonitoringWorkspaceSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &EnhancedSecurityMonitoringWorkspaceSettingParameters{}
