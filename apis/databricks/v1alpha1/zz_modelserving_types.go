...
type ModelServingInitParameters struct {
	...
	Tags []ModelServingTagsInitParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}
...
type ModelServingObservation struct {
	...
	// Tags to be attached to the serving endpoint and automatically propagated to billing logs.
	Tags []ModelServingTagsObservation `json:"tags,omitempty" tf:"tags,omitempty"`
}
...
type ModelServingParameters struct {
	...
	// Tags to be attached to the serving endpoint and automatically propagated to billing logs.
	// +kubebuilder:validation:Optional
	Tags []ModelServingTagsParameters `json:"tags,omitempty" tf:"tags,omitempty"`
}
...
type ModelServingTagsInitParameters struct {
...
type ModelServingTagsObservation struct {
...
type ModelServingTagsParameters struct {
...
// ModelServing is the Schema for the ModelServings API. ""subcategory: "Serving"
