...
func (mg *ComplianceSecurityProfileWorkspaceSetting) GetTerraformResourceType() string {
	return "databricks_compliance_security_profile_workspace_setting"
}
...
// LateInitialize this ComplianceSecurityProfileWorkspaceSetting using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *ComplianceSecurityProfileWorkspaceSetting) LateInitialize(attrs []byte) (bool, error) {
	params := &ComplianceSecurityProfileWorkspaceSettingParameters{}
